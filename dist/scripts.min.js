...
$(document).ready(function(){$("#toggle-input").click(function(){$("#search-animation").toggleClass("active")}),$(".menu-toggle").click(function(){$(this).toggleClass("active"),$(".ul-principal").toggleClass("active")}),$(".botton-arrow-home").click(function(){$(".pista-home").toggleClass("active"),$(".line-options-tab").toggleClass("active"),$(".buttons-tab-pista").toggleClass("active")})}),$(".carousel-foote-js").owlCarousel({loop:!0,margin:0,nav:!0,dots:!1,items:4,responsive:{0:{items:1},600:{items:3},1e3:{items:4}}}),$(".banner-carrosel").owlCarousel({loop:!0,nav:!1,dots:!0,items:1});var $doc=$("html, body");function countdown(){var t=new Date,e=new Date("january 1,2021 00:00:00"),o=t.getTime(),n=e.getTime()-o,a=Math.floor(n/1e3),s=Math.floor(a/60),l=Math.floor(s/60),i=Math.floor(l/24);l=(l%=24)<10?"0"+l:l,s=(s%=60)<10?"0"+s:s,a=(a%=60)<10?"0"+a:a,document.getElementById("days").textContent=i,document.getElementById("days").innerText=i,document.getElementById("hours").textContent=l,document.getElementById("minutes").textContent=s,document.getElementById("seconds").textContent=a,setTimeout(countdown,1e3)}$("a").click(function(){return $doc.animate({scrollTop:$($.attr(this,"href")).offset().top},500),!1}),countdown();